...
# # create users
# # @user_one = User.create(name: , email: "joshua@joshuaivie.com", photo: "https://avatars.dicebear.com/api/micah/joshua-ivie.svg", bio: "Joshua is a 24 year old builder", posts_counter: 0)
# # @user_two = User.create(name: "Sarah Ivie", email: "sarah@sarahivie.com", photo: "https://avatars.dicebear.com/api/micah/sarah-ivie.svg", bio: "Sarah is a 22 year old lawyer", posts_counter: 0)
# # @user_three = User.create(name: "Naomi Ivie", email: "naomi@naomivie.com", photo: "https://avatars.dicebear.com/api/micah/naomi-ivie.svg", bio: "Sarah is an 18 year old student", posts_counter: 0)

# @user_one = User.create(
# name: "Joshua Ivie", 
# photo: "https://avatars.dicebear.com/api/micah/joshua-ivie.svg",
# bio: "Joshua is a 24 year old builder",
# posts_counter: 0, 
# email: "joshua@joshuaivie.com", 
# encrypted_password: "", 
